...
<body>
    ...
    <script>
        ...
        // Função para redirecionar para a página de edição de notícia
        function editNoticia(noticiaId) {
            // Redirecione para a página de edição com o ID da notícia
            window.location.href = './editarNoticia.php?id=' + noticiaId;
        }
    </script>
